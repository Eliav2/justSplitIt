...
const isRefEqual = <T extends DocumentReference<any> | CollectionReference<any>>(
  v1: T | null | undefined,
  v2: T | null | undefined,
): boolean => {
...
export const useIsFirestoreRefEqual = <T extends DocumentReference<any> | CollectionReference<any>>(
